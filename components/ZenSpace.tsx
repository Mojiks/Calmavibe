...
const ZenSpace: React.FC = () => {
  ...
  const tracks: Track[] = [
    ...
    { id: '7', title: 'Sueño Relajante', url: '/sounds/suenorelajante.mp3', type: 'meditation' },
    { id: '8', title: 'Aliento de Buda', url: '/sounds/alientodebuda.mp3', type: 'meditation' },
    { id: '9', title: 'Sueño Profundo', url: '/sounds/frecuenciasueñoprofundo.mp3', type: 'meditation' },
